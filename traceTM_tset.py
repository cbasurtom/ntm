...
for file_name in ['data_a_plus_tset.csv', 'data_abc_star_tset.csv']:
    with open(file_name[:-8]+'inputs_tset.txt') as inputs, open('output_'+file_name[5:-4]+'.txt', 'w') as output:
